...
@router.get("/get/me", status_code=status.HTTP_200_OK, response_model=list[model.OrderWithProductAndUserAndDeliveryAnTruckGet])
...
@router.get("/get/{order_id}", status_code=status.HTTP_200_OK, response_model=model.OrderWithProductAndUserAndDeliveryAnTruckGet)
...
@router.get("/get", status_code=status.HTTP_200_OK, response_model=list[model.OrderWithProductAndUserAndDeliveryAnTruckGet])
...
@router.post("/create", status_code=status.HTTP_201_CREATED, response_model=model.OrderWithProductAndUserAndDeliveryAnTruckGet, summary="Создать новый заказ")
