...
@router.get("/get/me", status_code=status.HTTP_200_OK, response_model=model.UserWithAccessLevelGet)
...
@router.post("/create", status_code=status.HTTP_201_CREATED, response_model=model.UserWithAccessLevelGet, summary="Создать нового пользователя вручную")
